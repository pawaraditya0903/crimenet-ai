...
def generate_forensic_mugshot(
  ...
  <text x="120" y="224" font-family="sans-serif" font-size="9" font-weight="900" fill="#ffffff" text-anchor="middle">✓ VERIFIED CHIEF INVESTIGATOR</text>
        ...
        seed_num = sum(ord(c) for c in ip_str) % 4 + 1
        cctv_chan = f"CAM-0{seed_num}"
  ...
  <text x="30" y="22" font-family="monospace" font-size="9" font-weight="900" fill="#f87171">REC [{cctv_chan}]</text>
  <text x="228" y="22" font-family="monospace" font-size="8.5" font-weight="700" fill="#cbd5e1" text-anchor="end">{ip_str[:16]}</text>
  ...
  <text x="120" y="223" font-family="sans-serif" font-size="9" font-weight="900" fill="#ffffff" text-anchor="middle">🚨 {threat_level} — SURVEILLANCE CAPTURE</text>
</svg>"""
