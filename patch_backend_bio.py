...
# Add server-side biometric verification endpoints if not present
if "/api/security/verify-face" not in code:
    endpoints = """
...
print("Backend server-side biometric verification installed!")
