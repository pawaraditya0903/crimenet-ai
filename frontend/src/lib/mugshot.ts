export function getForensicMugshot(
  ...
  <line x1="0" y1="30" x2="240" y2="30" stroke="rgba(239,68,68,0.12)" stroke-width="1"/>
  <line x1="0" y1="60" x2="240" y2="60" stroke="rgba(239,68,68,0.12)" stroke-width="1"/>
  <line x1="0" y1="90" x2="240" y2="90" stroke="rgba(239,68,68,0.12)" stroke-width="1"/>
  <line x1="0" y1="120" x2="240" y2="120" stroke="rgba(239,68,68,0.12)" stroke-width="1"/>
  <line x1="0" y1="150" x2="240" y2="150" stroke="rgba(239,68,68,0.12)" stroke-width="1"/>
  <line x1="0" y1="180" x2="240" y2="180" stroke="rgba(239,68,68,0.12)" stroke-width="1"/>
  <line x1="0" y1="210" x2="240" y2="210" stroke="rgba(239,68,68,0.12)" stroke-width="1"/>
  ...
  <text x="32" y="22" font-family="monospace" font-size="9.5" font-weight="900" fill="#f87171">REC [CAM-0${seedNum}]</text>
  <text x="228" y="22" font-family="monospace" font-size="8.5" font-weight="700" fill="#94a3b8" text-anchor="end">${ipStr.slice(0, 15)}</text>
  <rect x="12" y="210" width="216" height="20" rx="4" fill="rgba(220,38,38,0.95)"/>
  <text x="120" y="224" font-family="sans-serif" font-size="9" font-weight="900" fill="#ffffff" text-anchor="middle">🚨 ${threatText} — MUGSHOT</text>
</svg>`
